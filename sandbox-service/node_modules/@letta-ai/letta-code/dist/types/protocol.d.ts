...
import type { AssistantMessage as LettaAssistantMessage, Message as LettaMessage, ReasoningMessage as LettaReasoningMessage, LettaStreamingResponse, ToolCallMessage as LettaToolCallMessage, ToolCall } from "@letta-ai/letta-client/resources/agents/messages";
...
export type { LettaStreamingResponse, LettaMessage, ToolCall, StopReasonType, MessageCreate, LettaToolReturnMessage, CreateBlock, };
/**
...
export interface RecoveryMessage extends MessageEnvelope {
    ...
    recovery_type: "approval_pending" | "approval_desync" | "invalid_tool_call_ids";
 ...
 */
export type QueueItemSource = "user" | "task_notification" | "subagent" | "system";
/**
 ...
 */
export type QueueItemKind = "message" | "task_notification" | "approval_result" | "overlay_action";
/**
 ...
 */
export type QueueBlockedReason = "streaming" | "pending_approvals" | "overlay_open" | "command_running" | "interrupt_in_progress" | "runtime_busy";
/**
 ...
 */
export type QueueClearedReason = "processed" | "error" | "cancelled" | "shutdown" | "stale_generation";
/**
 ...
 */
export type QueueLifecycleEvent = QueueItemEnqueuedEvent | QueueBatchDequeuedEvent | QueueBlockedEvent | QueueClearedEvent | QueueItemDroppedEvent;
...
export type SdkToCliControlRequest = {
    ...
    subtype: "interrupt";
} | RegisterExternalToolsRequest | BootstrapSessionStateRequest | ListMessagesControlRequest;
/**
...
export type CliToSdkControlRequest = CanUseToolControlRequest | ExecuteExternalToolRequest;
 ...
 */
export type WireMessage = SystemMessage | ContentMessage | StreamEvent | AutoApprovalMessage | CancelAckMessage | ErrorMessage | RetryMessage | RecoveryMessage | ResultMessage | ControlResponse | ControlRequest | QueueLifecycleEvent | TranscriptBackfillMessage | QueueSnapshotMessage | SyncCompleteMessage | TranscriptSupplementMessage;
