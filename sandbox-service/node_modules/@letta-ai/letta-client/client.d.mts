...
import { type ArrayPageParams, ArrayPageResponse, type NextFilesPageParams, NextFilesPageResponse, type ObjectPageParams, ObjectPageResponse } from "./core/pagination.mjs";
import * as Uploads from "./core/uploads.mjs";
import * as API from "./resources/index.mjs";
import * as TopLevelAPI from "./resources/top-level.mjs";
import { HealthResponse } from "./resources/top-level.mjs";
import { APIPromise } from "./core/api-promise.mjs";
import { AccessTokenCreateParams, AccessTokenCreateResponse, AccessTokenDeleteParams, AccessTokenDeleteResponse, AccessTokenListParams, AccessTokenListResponse, AccessTokens } from "./resources/access-tokens.mjs";
import { MessageListParams, MessageListResponse, MessageRetrieveResponse, MessageSearchParams, MessageSearchRequest, MessageSearchResponse, MessageSearchResult, Messages } from "./resources/messages.mjs";
import { Passage, PassageSearchParams, PassageSearchResponse, Passages } from "./resources/passages.mjs";
import { TagListParams, TagListResponse, Tags } from "./resources/tags.mjs";
import { NpmRequirement, PipRequirement, Tool, ToolCreate, ToolCreateParams, ToolDeleteResponse, ToolListParams, ToolReturnMessage, ToolSearchParams, ToolSearchRequest, ToolSearchResponse, ToolSearchResult, ToolType, ToolUpdateParams, ToolUpsertParams, Tools, ToolsArrayPage } from "./resources/tools.mjs";
...
import { Archive, ArchiveCreateParams, ArchiveListParams, ArchiveUpdateParams, Archives, ArchivesArrayPage, VectorDBProvider } from "./resources/archives/archives.mjs";
import { BlockCreateParams, BlockDeleteResponse, BlockListParams, BlockResponse, BlockResponsesArrayPage, BlockUpdateParams, Blocks, CreateBlock } from "./resources/blocks/blocks.mjs";
import { Conversation, ConversationCancelParams, ConversationCancelResponse, ConversationCreateParams, ConversationDeleteResponse, ConversationListParams, ConversationListResponse, ConversationRecompileParams, ConversationRecompileResponse, ConversationUpdateParams, Conversations, CreateConversation, UpdateConversation } from "./resources/conversations/conversations.mjs";
import { Folder, FolderCreateParams, FolderDeleteResponse, FolderListParams, FolderUpdateParams, Folders, FoldersArrayPage } from "./resources/folders/folders.mjs";
import { CreateSseMcpServer, CreateStdioMcpServer, CreateStreamableHTTPMcpServer, McpServerCreateParams, McpServerCreateResponse, McpServerListResponse, McpServerRefreshParams, McpServerRefreshResponse, McpServerRetrieveResponse, McpServerUpdateParams, McpServerUpdateResponse, McpServers, SseMcpServer, StdioMcpServer, StreamableHTTPMcpServer, UpdateSseMcpServer, UpdateStdioMcpServer, UpdateStreamableHTTPMcpServer } from "./resources/mcp-servers/mcp-servers.mjs";
import { EmbeddingConfig, EmbeddingModel, LlmConfig, Model, ModelListParams, ModelListResponse, Models, ProviderCategory, ProviderType } from "./resources/models/models.mjs";
import { Job, RunListParams, Runs, StopReasonType } from "./resources/runs/runs.mjs";
import { ProviderTrace, Step, StepListParams, Steps, StepsArrayPage } from "./resources/steps/steps.mjs";
import { TemplateCreateParams, TemplateCreateResponse, TemplateDeleteParams, TemplateDeleteResponse, TemplateRollbackParams, TemplateRollbackResponse, TemplateSaveParams, TemplateSaveResponse, TemplateUpdateParams, TemplateUpdateResponse, Templates } from "./resources/templates/templates.mjs";
...
export declare class Letta {
    ...
    private _makeAbort;
    private buildBody;
    static Letta: typeof Letta;
    static DEFAULT_TIMEOUT: number;
    static LettaError: typeof Errors.LettaError;
