...
export interface LlmConfig {
     ...
     * The endpoint type for the model.
     */
    model_endpoint_type: 'openai' | 'anthropic' | 'google_ai' | 'google_vertex' | 'azure' | 'groq' | 'ollama' | 'webui' | 'webui-legacy' | 'lmstudio' | 'lmstudio-legacy' | 'lmstudio-chatcompletions' | 'llamacpp' | 'koboldcpp' | 'vllm' | 'hugging-face' | 'minimax' | 'mistral' | 'together' | 'bedrock' | 'deepseek' | 'xai' | 'zai' | 'baseten' | 'fireworks' | 'openrouter' | 'chatgpt_oauth';
    /**
...
export interface Model {
     ...
     * the model.
     */
    model_endpoint_type: 'openai' | 'anthropic' | 'google_ai' | 'google_vertex' | 'azure' | 'groq' | 'ollama' | 'webui' | 'webui-legacy' | 'lmstudio' | 'lmstudio-legacy' | 'lmstudio-chatcompletions' | 'llamacpp' | 'koboldcpp' | 'vllm' | 'hugging-face' | 'minimax' | 'mistral' | 'together' | 'bedrock' | 'deepseek' | 'xai' | 'zai' | 'openrouter' | 'chatgpt_oauth';
    /**
     * The actual model name used by the provider
     */
    name: string;
...
export type ProviderType = 'anthropic' | 'azure' | 'baseten' | 'bedrock' | 'cerebras' | 'chatgpt_oauth' | 'deepseek' | 'fireworks' | 'google_ai' | 'google_vertex' | 'groq' | 'hugging-face' | 'letta' | 'lmstudio_openai' | 'minimax' | 'mistral' | 'ollama' | 'openai' | 'together' | 'vllm' | 'sglang' | 'openrouter' | 'xai' | 'zai';
