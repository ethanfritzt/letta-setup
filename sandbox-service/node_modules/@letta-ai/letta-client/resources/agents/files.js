...
class Files extends resource_1.APIResource {
    ...
    close(fileID, params, options) {
        ...
        return this._client.patch((0, path_1.path) `/v1/agents/${agent_id}/files/${fileID}/close`, options);
    }
    /**
    ...
    closeAll(agentID, options) {
        return this._client.patch((0, path_1.path) `/v1/agents/${agentID}/files/close-all`, options);
    }
    /**
    ...
    open(fileID, params, options) {
        const { agent_id } = params;
        return this._client.patch((0, path_1.path) `/v1/agents/${agent_id}/files/${fileID}/open`, options);
    }
}
exports.Files = Files;
