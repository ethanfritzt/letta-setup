...
export declare namespace CompactionRequest {
    /**
     * Configuration for conversation compaction / summarization.
     *
     * Per-model settings (temperature, max tokens, etc.) are derived from the default
...
export declare namespace MessageCompactParams {
    /**
     * Configuration for conversation compaction / summarization.
     *
     * Per-model settings (temperature, max tokens, etc.) are derived from the default
...
export declare namespace Messages {
    export { type CompactionRequest as CompactionRequest, type CompactionResponse as CompactionResponse, type MessageStreamResponse as MessageStreamResponse, type MessageCreateParams as MessageCreateParams, type MessageListParams as MessageListParams, type MessageCompactParams as MessageCompactParams, type MessageStreamParams as MessageStreamParams, };
}
