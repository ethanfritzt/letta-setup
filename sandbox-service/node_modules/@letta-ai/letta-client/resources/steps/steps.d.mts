...
import * as FeedbackAPI from "./feedback.mjs";
import { Feedback, FeedbackCreateParams } from "./feedback.mjs";
import * as StepsMessagesAPI from "./messages.mjs";
import { MessageListParams, MessageListResponse, MessageListResponsesArrayPage, Messages } from "./messages.mjs";
import * as MetricsAPI from "./metrics.mjs";
import { MetricRetrieveResponse, Metrics } from "./metrics.mjs";
...
export declare class Steps extends APIResource {
    ...
    messages: StepsMessagesAPI.Messages;
    /**
     * Get a step by ID.
     */
...
export declare namespace Steps {
    ...
    export { Messages as Messages, type MessageListResponse as MessageListResponse, type MessageListResponsesArrayPage as MessageListResponsesArrayPage, type MessageListParams as MessageListParams, };
}
