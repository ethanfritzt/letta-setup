...
export declare class AccessTokens extends APIResource {
     ...
     */
    delete(token: string, params?: AccessTokenDeleteParams | null | undefined, options?: RequestOptions): APIPromise<unknown>;
}
...
export declare namespace AccessTokenCreateResponse {
    interface Policy {
...
export declare namespace AccessTokenListResponse {
    interface Token {
        token: string;
        expiresAt: string;
        hostname: string;
