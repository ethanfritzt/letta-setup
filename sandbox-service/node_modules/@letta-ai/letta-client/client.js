...
var _Letta_instances, _a, _Letta_encoder, _Letta_baseURLOverridden;
Object.defineProperty(exports, "__esModule", { value: true });
exports.Letta = void 0;
...
const access_tokens_1 = require("./resources/access-tokens.js");
const messages_1 = require("./resources/messages.js");
const passages_1 = require("./resources/passages.js");
const tags_1 = require("./resources/tags.js");
const tools_1 = require("./resources/tools.js");
const agents_1 = require("./resources/agents/agents.js");
const archives_1 = require("./resources/archives/archives.js");
const blocks_1 = require("./resources/blocks/blocks.js");
...
const runs_1 = require("./resources/runs/runs.js");
const steps_1 = require("./resources/steps/steps.js");
const templates_1 = require("./resources/templates/templates.js");
...
class Letta {
     ...
     */
    constructor({ baseURL = (0, env_1.readEnv)('LETTA_BASE_URL'), apiKey = (0, env_1.readEnv)('LETTA_API_KEY') ?? null, projectID = null, project = null, ...opts } = {}) {
        _Letta_instances.add(this);
        _Letta_encoder.set(this, void 0);
        this.agents = new API.Agents(this);
        this.tools = new API.Tools(this);
        this.blocks = new API.Blocks(this);
        this.archives = new API.Archives(this);
        this.folders = new API.Folders(this);
        this.models = new API.Models(this);
        this.mcpServers = new API.McpServers(this);
        this.runs = new API.Runs(this);
        this.steps = new API.Steps(this);
        this.templates = new API.Templates(this);
        this.tags = new API.Tags(this);
        this.messages = new API.Messages(this);
        this.passages = new API.Passages(this);
        ...
        if (baseURL && opts.environment) {
            throw new Errors.LettaError('Ambiguous URL; The `baseURL` option (or LETTA_BASE_URL env var) and the `environment` option are given. If you want to use the environment you must pass baseURL: null');
        }
        ...
        this.logLevel =
            (0, log_1.parseLogLevel)(options.logLevel, 'ClientOptions.logLevel', this) ??
                (0, log_1.parseLogLevel)((0, env_1.readEnv)('LETTA_LOG'), "process.env['LETTA_LOG']", this) ??
                defaultLogLevel;
        this.fetchOptions = options.fetchOptions;
        this.maxRetries = options.maxRetries ?? 2;
        this.fetch = options.fetch ?? Shims.getDefaultFetch();
        tslib_1.__classPrivateFieldSet(this, _Letta_encoder, Opts.FallbackEncoder, "f");
    ...
    buildURL(path, query, defaultBaseURL) {
        const baseURL = (!tslib_1.__classPrivateFieldGet(this, _Letta_instances, "m", _Letta_baseURLOverridden).call(this) && defaultBaseURL) || this.baseURL;
    ...
    buildBody({ options: { body, headers: rawHeaders } }) {
        ...
        ArrayBuffer.isView(body) ||
            ...
            return tslib_1.__classPrivateFieldGet(this, _Letta_encoder, "f").call(this, { body, headers });
        }
    }
}
exports.Letta = Letta;
_a = Letta, _Letta_encoder = new WeakMap(), _Letta_instances = new WeakSet(), _Letta_baseURLOverridden = function _Letta_baseURLOverridden() {
    return this.baseURL !== environments[this._options.environment || 'cloud'];
};
Letta.Letta = _a;
Letta.DEFAULT_TIMEOUT = 60000; // 1 minute
Letta.LettaError = Errors.LettaError;
Letta.APIError = Errors.APIError;
Letta.APIConnectionError = Errors.APIConnectionError;
Letta.APIConnectionTimeoutError = Errors.APIConnectionTimeoutError;
Letta.APIUserAbortError = Errors.APIUserAbortError;
Letta.NotFoundError = Errors.NotFoundError;
Letta.ConflictError = Errors.ConflictError;
Letta.RateLimitError = Errors.RateLimitError;
Letta.BadRequestError = Errors.BadRequestError;
Letta.AuthenticationError = Errors.AuthenticationError;
Letta.InternalServerError = Errors.InternalServerError;
Letta.PermissionDeniedError = Errors.PermissionDeniedError;
Letta.UnprocessableEntityError = Errors.UnprocessableEntityError;
Letta.toFile = Uploads.toFile;
Letta.Agents = agents_1.Agents;
Letta.Tools = tools_1.Tools;
Letta.Blocks = blocks_1.Blocks;
Letta.Archives = archives_1.Archives;
Letta.Folders = folders_1.Folders;
Letta.Models = models_1.Models;
Letta.McpServers = mcp_servers_1.McpServers;
Letta.Runs = runs_1.Runs;
Letta.Steps = steps_1.Steps;
Letta.Templates = templates_1.Templates;
Letta.Tags = tags_1.Tags;
Letta.Messages = messages_1.Messages;
Letta.Passages = passages_1.Passages;
Letta.Conversations = conversations_1.Conversations;
Letta.AccessTokens = access_tokens_1.AccessTokens;
